                        ...
                        <div key={item.id} className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden flex flex-col hover:shadow-md transition-shadow duration-200 group relative">
                            ...
                            <div className="h-40 bg-gray-200 dark:bg-gray-700 relative overflow-hidden">
                                ...
                                <div className="absolute top-2 right-2">
                                    <span className={`px-2 py-1 rounded text-xs font-bold shadow-sm ${item.isVeg
                                ...
                                <div className="mt-4 flex items-center justify-between">
                                    ...
                                    {item.isAvailable && (
                                        <button
                                            ...
                                            className="bg-primary-50 text-primary-700 hover:bg-primary-100 dark:bg-primary-900/30 dark:text-primary-300 dark:hover:bg-primary-900/50 py-1 px-3 rounded-lg text-sm font-medium transition-colors"
                                        >
                                            Add
                                        </button>
                                    )}
